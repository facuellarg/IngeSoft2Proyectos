...
class DocentesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create docente" do
    assert_difference('Docente.count') do
      post docentes_url, params: { docente: { email: @docente.email, facultad: @docente.facultad, id: @docente.id, name: @docente.name, password: @docente.password } }, as: :json
    end
  ...
  test "should update docente" do
    patch docente_url(@docente), params: { docente: { email: @docente.email, facultad: @docente.facultad, id: @docente.id, name: @docente.name, password: @docente.password } }, as: :json
    assert_response 200
  end
