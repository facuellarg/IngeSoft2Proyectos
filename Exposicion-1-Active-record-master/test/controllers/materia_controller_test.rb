...
class MateriaControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create materium" do
    assert_difference('Materium.count') do
      post materia_url, params: { materium: { codigo: @materium.codigo, id: @materium.id, name: @materium.name, planestudios: @materium.planestudios, profesor: @materium.profesor } }, as: :json
    end
  ...
  test "should update materium" do
    patch materium_url(@materium), params: { materium: { codigo: @materium.codigo, id: @materium.id, name: @materium.name, planestudios: @materium.planestudios, profesor: @materium.profesor } }, as: :json
    assert_response 200
  end
